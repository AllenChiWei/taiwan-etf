...
export const CHANGELOG: ChangeDay[] = [
  {
    ...
    items: [
      ...
      { kind: 'fix', to: '/calc',
        text: '退休推估的資產累積圖在金額很大時，左邊的刻度會被切掉、在手機上也縮得很小；現在照實際寬度畫，'
          + '刻度完整顯示（到「兆」也行）。圖下新增逐年明細表：每年投入、累計投入、資產、累計報酬與今天購買力。' },
      ...
      { kind: 'fix', to: '/stock',
        text: '金控、銀行、保險、證券與幾檔特殊產業的個股，財務報表原本顯示「還沒有財報資料」，'
          + '現在有了（銀行與金控的營收欄改稱「淨收益」）。' },
    ],
  },
  {
    date: '2026-09-23',
