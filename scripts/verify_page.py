...
# --- row internals: 11 cells, cell text agrees with the data-* attributes ------
# 代號 / 名稱 / 保管銀行 / 配息 / 殖利率 / 近3月 / 近6月 / 近1年 / 近3年 / 近5年 / 詳情
NCELLS = 11
...
# 6 sortable headers (殖利率 + 5 returns) in each of the 6 section tables. The
...
print('sortable headers: %d (%d tables x 6)' % (n_sortable, n_tables))
if n_sortable != n_tables * 6:
    fails.append('expected %d sortable headers, found %d' % (n_tables * 6, n_sortable))
